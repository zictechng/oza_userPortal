            ...
            <Flex flexDirection="column">
              ...
              >
                <Button
                  ...
                  onClick={()=> uploadPhoto() }
                >
                  {loading ? <Text><Spinner color="white.500" animationDuration="0.8s" size="sm" /> Processing</Text> : 'Upload Photo'}
                </Button>
              </Flex>
            </Flex>
            ):<Heading fontSize="xl" color={'#aaa'}>
            {'Profile photo has already been uploaded! There is nothing to do at the moment.'}
            </Heading> }</>
  );
}

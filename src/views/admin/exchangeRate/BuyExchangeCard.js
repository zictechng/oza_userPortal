...
export default function BuyExchange(props) {
  const { ...rest } = props;
  ...
  const [noCurrentRate, setNoCurrentRate] = useState(false);
        ...
        <Card
          ...
          <Flex direction='column' py='5px' align='center'>
            ...
            <Text fontSize='lg' color={textColor} fontWeight='700'>
              {<DollarValueFormat value={currentRate?.paypal_buying} />}
            </Text>
          </Flex>
          ...
          <Flex direction='column' py='5px' me='10px'>
            ...
            <Text fontSize='lg' color={textColor} fontWeight='700'>
            {<DollarValueFormat value={currentRate?.payoneer_buying} />}
            </Text>
          </Flex>
          <VSeparator mx={{ base: "60px", xl: "60px", "2xl": "60px" }} />
          <Flex direction='column' py='5px' me='10px'>
            ...
            <Text fontSize='lg' color={textColor} fontWeight='700'>
            {<DollarValueFormat value={currentRate?.btc_buying} />}
            </Text>
          </Flex>
        </Card>:

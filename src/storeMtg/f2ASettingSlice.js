...
const f2aSettingSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      .addCase(post2FAMode.pending, (state) => {
      ...
      .addCase(post2FAMode.fulfilled, (state, action) => {
      ...
      .addCase(post2FAMode.rejected, (state, action) => {
        state.dataLoading = false;
        state.postData = null;
        state.postStatus = null;
...
export const post2FAMode = createAsyncThunk(
  "user/f2a_mode",
